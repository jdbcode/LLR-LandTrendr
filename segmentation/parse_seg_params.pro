function parse_seg_params, outdir, segparamstxt, image_info_savefile, mask_image=mask_image, subset=subset, eval=eval, resume=resume
  ...
  for i=0, n_runs-1 do begin
    ...
    outbase = outdir+"\"+theruns[i].index+"\LT_"+landtrendr_version()+"_"+theruns[i].index+"_"
