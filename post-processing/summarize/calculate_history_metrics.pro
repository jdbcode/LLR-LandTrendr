...
;      slb_t[this_index] = fix((b_stack[bgw_index[seg_start+1]] - b_stack[bgw_index[seg_start]])/(bgw_index[seg_start+1] - bgw_index[seg_start]))
;      slg_t[this_index] = fix((g_stack[bgw_index[seg_start+1]] - g_stack[bgw_index[seg_start]])/(bgw_index[seg_start+1] - bgw_index[seg_start]))
;      slw_t[this_index] = fix((g_stack[bgw_index[seg_start+1]] - g_stack[bgw_index[seg_start]])/(bgw_index[seg_start+1] - bgw_index[seg_start]))
