...
function no_cover_model_greenness, spectral_value, equation=equation
...
;  the range of values for the given index
  ...
  cover_value = spectral_value + 10000 ;adding 10000 (arbitrary - just can't force the values above 32,767) to get values above 0
  equation = 'spectral_value + 10000'
  return, cover_value
