...
function no_cover_model_wetness, spectral_value, equation=equation
...
;  the range of values for the given index
  ...
  cover_value = spectral_value + 20000 ;adding 20000 (arbitrary - just can't force the values above 32,767) to get values above 0
  equation = 'spectral_value + 20000'
  return, cover_value
